...
public class ProfileController {
    ...
    @Operation(summary = "반려견 프로필 등록 API", description = "multipart/form-data 타입의 데이터의 소비를 설정하여, 1개의 이미지 파일과 반려견 프로필을 한번에 등록하고 반려견 프로필 정보 반환 (이미지 미포함)")
    ...
    @Operation(summary = "반려견 프로필 수정 API", description = "multipart/form-data 타입의 데이터의 소비를 설정하여, 1개의 이미지 파일과 반려견 프로필을 한번에 수정하고 반려견 프로필 정보 반환 (이미지 미포함)")
